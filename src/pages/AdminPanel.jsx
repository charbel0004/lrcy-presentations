  ...
  const createPresenter = async () => {
    ...
    try {
      const res = await api("/api/admin/users", {
        method: "POST",
        body: JSON.stringify({ fullName: fn, username: un, password }),
      });

      setMsg(`Presenter created (id: ${res.userId}).`);
      setFullName("");
      setUsername("");
      setPassword("");
      load();
      ...
      <div className="relative p-6">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          {overview && (
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              {[
                ...
                <div
                  key={k}
                  className="rounded-2xl bg-neutral-900/60 border border-neutral-800 p-4"
                >
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <div className="text-xs text-neutral-400 mt-1">
                  Shows who spun, and which topic they received.
                </div>
              </div>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-neutral-100">
                  {filteredPresenters.length === 0 ? (
                    <tr>
                      <td className="py-4 text-neutral-400" colSpan={5}>
                        No presenters found.
                      </td>
                    </tr>
                  ) : (
                    filteredPresenters.map((p) => (
                      <tr
                        key={p._id}
                        className="border-t border-neutral-800 hover:bg-neutral-950/40 transition"
                      >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* Create Presenter */}
            <div className="rounded-2xl bg-neutral-900/60 border border-neutral-800 p-6">
              <h2 className="text-base font-semibold">Create Presenter Account</h2>
